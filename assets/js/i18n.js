...
const TRANSLATIONS = {
  es: {
    ...
    /* Clientes */
    clients_title:    'Nuestros Aliados',
    clients_subtitle: 'Empresas que confían en Corporación ARC S.A.',
    ...
    option_auto:      'ARC Automotriz — Taller Mecánico',
    option_print:     'ARC Print — Impresión y Sublimado',
    option_logistics: 'ARC Logistics — Transporte y Camiones',
    option_talent:    'ARC Talent — Outsourcing RH',
    ...
    footer_copy:      '© 2026 Corporación ARC S.A. Todos los derechos reservados.',
  },
  ...
  en: {
    ...
    clients_subtitle: 'Companies that trust Corporación ARC S.A.',
    ...
    option_auto:      'ARC Automotive — Auto Shop',
    option_print:     'ARC Print — Printing & Sublimation',
    option_logistics: 'ARC Logistics — Transport & Trucks',
    option_talent:    'ARC Talent — HR Outsourcing',
    ...
    footer_copy:      '© 2026 Corporación ARC S.A. All rights reserved.',
  }
};
...
const I18N = {
  ...
  init() {
    // Detectar idioma guardado o preferencia del navegador
  ...
  apply() {
    ...
    // Guardar preferencia
    localStorage.setItem('arc_lang', this.current);
  },
